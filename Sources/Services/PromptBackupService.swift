...
final class PromptBackupService {
    ...
    private let logger = Logger(subsystem: "com.ranax.prompthub", category: "PromptBackupService")
    private let lastKnownPromptCountKey = "com.ranax.prompthub.prompts.lastKnownPromptCount"
    private let intentionallyEmptyKey = "com.ranax.prompthub.prompts.userIntentionallyEmptiedLibrary"
    ...
    private var appSupportDirectory: URL {
        FileManager.default.urls(
            ...
            in: .userDomainMask
        )[0].appendingPathComponent("PromptHub", isDirectory: true)
    }
