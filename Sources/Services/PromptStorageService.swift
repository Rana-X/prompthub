...
final class PromptStorageService {
    ...
    private let logger = Logger(subsystem: "com.ranax.prompthub", category: "PromptStorageService")
    private let migrationCompleteKey = "com.ranax.prompthub.storage.explicitStoreMigrationComplete"
    ...
    private var appSupportDirectory: URL {
        applicationSupportRoot.appendingPathComponent("PromptHub", isDirectory: true)
    }

    private var currentStoreURL: URL {
        appSupportDirectory.appendingPathComponent("PromptHub.store")
    }
    ...
    private func migrateLegacyStoreIfNeeded() {
        ...
        logger.info("Migrating legacy default SwiftData store to explicit PromptHub store path")
        ...
        do {
            ...
            logger.info("Migrated \(legacyPrompts.count) prompts to explicit PromptHub store path")
        } catch {
